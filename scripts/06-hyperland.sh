...
sudo pacman -Sy --needed --noconfirm hyprland kitty waybar hyprpaper bc brightnessctl dunst libnotify pavucontrol alacritty nautilus fastfetch hyprlock hyprcursors
...
if [ $? -eq 0 ]; then
  ...
  for folder in alacritty hypr hyprpaper waybar wofi hyprlock; do
