...
sudo pacman -Sy --needed --noconfirm hyprland kitty waybar hyprpaper bc brightnessctl dunst libnotify pipewire wireplumber pipewire-pulse pipewire-alsa pavucontrol alacritty nautilus fastfetch
